...
int main() {
    {
        std::stringstream ss, out, answer;
        ss << 1 << std::endl << 10 << " " << 1 << " " << 1 << std::endl;
        answer << "Median age = 10\n";
        answer << "Median age for females = 0\n";
        answer << "Median age for males = 10\n";
        answer << "Median age for employed females = 0\n";
        answer << "Median age for unemployed females = 0\n";
        answer << "Median age for employed males = 10\n";
        answer << "Median age for unemployed males = 0\n";
        PrintStats(ComputeStats(ReadPersons(ss)), out);
        ASSERT_EQUAL(out.str(), answer.str());
    }
    {
        std::stringstream ss, out, answer;
        ss << 1 << std::endl << 10 << " " << 1 << " " << 0 << std::endl;
        answer << "Median age = 10\n";
        answer << "Median age for females = 0\n";
        answer << "Median age for males = 10\n";
        answer << "Median age for employed females = 0\n";
        answer << "Median age for unemployed females = 0\n";
        answer << "Median age for employed males = 0\n";
        answer << "Median age for unemployed males = 10\n";
        PrintStats(ComputeStats(ReadPersons(ss)), out);
        ASSERT_EQUAL(out.str(), answer.str());
    }
    {
